...
class ClinicsPatientsExport implements FromCollection,WithHeadings,WithColumnWidths,WithStyles
{
    ...
    */
    public function collection()
    {
		...
		$data = PatientAppointment::where('trial_clinic_user_id', JWTAuth::user()->id)->where('status' , '>', 0);
