...
class PhysiciansPatientsExport implements FromCollection,WithHeadings,WithColumnWidths,WithStyles
{
    ...
    */
    public function collection()
    {
        ...
        ->whereHas('patientUserInfo', function ($query) {
            $query->where('physician_id', JWTAuth::user()->id);
        });
		...
		$data = $data->with(['patientUserInfo' => function ($query) {
