...
<div class="page-title col-sm-12">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="heading-main-top">Edit Political Party</h1>
        </div>
        <div class="col-md-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit Political Party</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 col-md-4 mb-4">
            {!! Form::model($entity, ['route' => ['superadmin.update_political_party'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'editPoliticalPartyForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
                ...
                <div class="box-row flex-wrap comman-form-design">
                    ...
                    <!-- <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="">
                                {!! Form::password('password', array('required'=>'required', 'id' => 'password', 'class' => 'form-control','placeholder'=>'Password', 'maxlength'=>11,'minlength' =>6)) !!}
                                <span class="help-block">
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        ...
                        <a href="javascript:void(0);" onclick="editPoliticalPartyForm();" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            {{ Form::close() }}
        </div>
...
$("#editPoliticalPartyForm").validate({
    rules: {
        party_name: {
            required: true,
            maxlength: 100,
...
function editPoliticalPartyForm(){
    // show loader
    showCustomBlockUI();
    if($("#editPoliticalPartyForm").valid()){
        $("#editPoliticalPartyForm").submit();
    }else{
        // hide loader
        hideCustomBlockUI();
    }
