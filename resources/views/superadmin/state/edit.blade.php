        ...
        <div class="col-md-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb m-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit State Management</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 col-md-4 mb-4">
            {!! Form::model($entity, ['route' => ['superadmin.update_state'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'editStateForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
           <input type="hidden" name="update_id" value="{{ $entity->id }}">
                <div class="box-row flex-wrap">
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        <a type="submit" href="{{ route('superadmin.list_state') }}" class="btn light">Cancel</a>
