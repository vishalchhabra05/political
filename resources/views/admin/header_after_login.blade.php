<head>
    ...
    <link href="{{ asset('developer.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('css/admin/jquery-confirm.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('css/admin/sweetalert.css') }}" rel="stylesheet" type="text/css">
