...
@section('content')
        <div class="page-title col-sm-12">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1 class="heading-main-top">CMS Management</h1>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="box bg-white comman-form-design">
                        <div class="box-row">
                            <div class="box-content">
                                <table id="table_dataTable" class="table table-striped table-bordered table-hover cms-table">
                                    <thead>
                                        <tr>
