...
<div class="page-title col-sm-12">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="heading-main-top">Edit Custom Field</h1>
        </div>
        <div class="col-md-6">
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 col-md-4 mb-4">
            {!! Form::model($entity, ['route' => ['update_form_customization'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'editPoliticalPartyCustomForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
            <input type="hidden" name="update_id" value="{{ $entity->id }}">
                <?php $isFieldsDisabled = ($isFormFieldUsed == 0?false:true); ?>
                <div class="box-row flex-wrap comman-form-design">
                    <!-- <div class="col-md-6 mb-3">
                        <div class="form-group">
                            <label>Select Political Party<span class="required">*</span></label>
                            <div class="">
                                <!-- {!! Form::select('political_party', (!empty($politicalParties)?$politicalParties:[]), null, ['class' => 'form-control', 'disabled'=>'true', 'id'=>'political_party', 'placeholder'=> 'Select Political Party']) !!} -->
                                <!--{!! Form::text('political_party', null, ['id'=>'political_party', 'class'=>'form-control chkAlphabets', 'readonly'=>'true','placeholder'=>'Political Party Name']) !!}
                    ...
                    <input type="hidden" name="isFormFieldUsed" value="{{$isFormFieldUsed}}">
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                    ...
                    @if($formType == 'profile')
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <div class="">
                                    @if($isFieldsDisabled == 0)
                                        {!! Form::select('tab_type', (!empty($customFieldTabs)?$customFieldTabs:[]), null, ['class' => 'form-control','id'=>'tab_type', 'placeholder'=> 'Select', 'disabled'=> $isFieldsDisabled]) !!}
                                    @else
                                        {!! Form::text('tab_type', null, ['id'=>'tab_type', 'class'=>'form-control chkAlphabets', 'readonly'=>'true','placeholder'=>'Is Required']) !!}
                                    @endif
                                    <span class="help-block">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="">
                                @if($isFieldsDisabled == 0)
                                    {!! Form::select('is_required', (!empty($isRequiredTypes)?$isRequiredTypes:[]), null, ['class' => 'form-control','id'=>'is_required', 'placeholder'=> 'Select', 'disabled'=> $isFieldsDisabled]) !!}
                                @else
                                    {!! Form::text('is_required', null, ['id'=>'is_required', 'class'=>'form-control chkAlphabets', 'readonly'=>'true','placeholder'=>'Is Required']) !!}
                                @endif
                                <span class="help-block">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="seclect-tow-design">
                                @if($isFieldsDisabled == 0)
                                    {!! Form::select('field_type', (!empty($fieldTypes)?$fieldTypes:[]), null, ['class' => 'form-control', 'disabled'=> $isFieldsDisabled,'id'=>'field_type', 'placeholder'=> 'Select Field Type']) !!}
                                @else
                                    {!! Form::text('field_type', null, ['id'=>'field_type', 'class'=>'form-control chkAlphabets', 'readonly'=>'true','placeholder'=>'Field Type']) !!}
                                @endif
                                <span class="help-block">
                    ...
                    <div class="col-md-6 mb-3" id="fieldMinLngthDiv" style="display:none;">
                        <div class="form-group">
                            ...
                            <div class="">
                                {!! Form::number('field_min_length', null, ['id'=>'field_min_length', 'class'=>'form-control chkNumber', 'disabled'=> $isFieldsDisabled, 'placeholder'=>'Field Minimum Length']) !!}
                                <span class="help-block">
                    ...
                    <div class="col-md-6 mb-3" id="fieldMaxLngthDiv" style="display:none;">
                        <div class="form-group">
                            ...
                            <div class="">
                                {!! Form::number('field_max_length', null, ['id'=>'field_max_length', 'class'=>'form-control chkNumber', 'disabled'=> $isFieldsDisabled, 'placeholder'=>'Field Maximum Length']) !!}
                                <span class="help-block">
                    ...
                    <div class="col-md-6 mb-3" id="fieldDecPointDiv" style="display:none;">
                        <div class="form-group">
                            ...
                            <div class="">
                                {!! Form::number('decimal_points', null, ['id'=>'decimal_points', 'class'=>'form-control chkNumber', 'disabled'=> $isFieldsDisabled, 'placeholder'=>'Decimal Points']) !!}
                                <span class="help-block">
                    ...
                    @if(!empty($entity->formFieldOptionInfo))
                    <div class="col-md-6 mb-3">
                        <b> Saved Field Options -</b> {{ $entity->formFieldOptionInfo }}
                    </div>
                    @endif
                    <div class="col-md-12 mb-3 text-center">
                        <a href="{{ route('list_form_customization',['formType' => $formType, 'formId' => $formId]) }}" class="btn btn-primary">Cancel</a>
                        <a href="javascript:void(0);" onclick="editPoliticalPartyCustomForm();" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            {{ Form::close() }}
        </div>
...
$("#editPoliticalPartyCustomForm").validate({
    rules: {
        /*political_party: {
            required: true,
        },*/
...
var isFormFieldUsed = '{{$isFormFieldUsed}}';
...
function editPoliticalPartyCustomForm(){
    // show loader
    showCustomBlockUI();
    if($("#editPoliticalPartyCustomForm").valid()){
        $("#editPoliticalPartyCustomForm").submit();
    }else{
        // hide loader
        hideCustomBlockUI();
    }
