...
<div class="page-title col-sm-12">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="heading-main-top">Edit Category</h1>
        </div>
        <div class="col-md-6">
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 col-md-4 mb-4">
            {!! Form::model($entity, ['route' => ['update_categories'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'editCategoryForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
            <input type="hidden" name="update_id" value="{{ $entity->id }}">
                <div class="box-row flex-wrap comman-form-design">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="upload-img">
                                ...
                                @if($entity->image)
                                    <img class="profile-user-img img-responsive img-circle" src="{{$entity->image}}" alt="image" id="previewOldImg" width="100" style="padding-top: 10px;">
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3 text-left">
                        ...
                        <a href="javascript:void(0);" onclick="editCategoryForm();" class="btn btn-primary">Submit</a>
                    </div>
                </div>
            {{ Form::close() }}
        </div>
