...
<div class="page-title col-sm-12">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3 m-0">Add Sub Admin</h1>
        </div>
        <div class="col-md-6">
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 col-md-4 mb-4">
            {!! Form::model($entity, ['route' => ['store_sub_admin'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'addSubAdminForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
            {{ csrf_field() }}
                <div class="box-row flex-wrap comman-form-design">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="upload-img upload-file-img">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <div class="multi-select-input">
                                @php $permissions = getpermission(); @endphp
                    ...
                    <div class="col-md-12 mb-3 text-center">
                        ...
                        <a href="javascript:void(0);" onclick="addSubAdminForm();" class="btn btn-primary ">Submit</a>
                    </div>
                </div>
            {{ Form::close() }}
        </div>
