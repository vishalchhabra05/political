...
@section('content')
        <div class="page-title col-sm-12">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1 class="heading-main-top">Add FAQ</h1>
                </div>
                <div class="col-md-6">
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-lg-12 col-md-4 mb-4">
                    {!! Form::model($entity, ['route' => ['store_faq'], 'method' => 'POST', 'class'=>'box bg-white validate', 'id'=>'addFaqForm', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data']) !!}
                    {{ csrf_field() }}
                        <div class="box-row flex-wrap comman-form-design">
                            ...
                            <div class="col-md-12 mb-3 text-center">
                                <a href="{{ route('list_faq') }}" class="btn btn-primary">Cancel</a>
                                <a href="javascript:void(0);" onclick="addFaqForm();" class="btn btn-primary">Submit</a>
                            </div>
                        </div>
                    {{ Form::close() }}
                </div>
